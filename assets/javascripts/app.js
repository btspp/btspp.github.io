...
function createMobileHeader() {
  ...
  dom_header_problem.innerText = "常见问题";
  ...
  bottom_bar.style.backgroundColor = "#090f23";
  ...
  bottom_bar.style.paddingTop = "8px";
  bottom_bar.className = "clearfix";

  var bottom_block_left = document.createElement("a");
  bottom_block_left.setAttributeNode(createDomAttr("href", "https://app.btspp.io"));
  bottom_block_left.style.display = "block";
  bottom_block_left.style.width = "40%";
  bottom_block_left.style.marginLeft = "5%";
  bottom_block_left.style.height = "28px";
  bottom_block_left.className = "fl";
  bottom_block_left.style.textAlign = "center";
  bottom_block_left.style.border = "1px solid rgb(199, 204, 230)";
  bottom_block_left.style.borderRadius = "6px";

  var bottom_block_right = bottom_block_left.cloneNode();
  bottom_block_right.setAttributeNode(createDomAttr("href", "https://app.btspp.io"));
  bottom_block_right.className = "fr";
  bottom_block_right.style.marginRight = "5%";
  ...
  ios_text.style.color = "rgb(199, 204, 230)";
  ios_text.style.fontSzie = "12px";
  ios_text.style.paddingLeft = "4px";
  ios_text.innerText = BTS.I18N.nameAppleDownload;

  var android_text = ios_text.cloneNode();
  android_text.innerText = BTS.I18N.nameAndroidDownload;

  bottom_block_left.appendChild(dom_download_ios)
  bottom_block_left.appendChild(ios_text)
  bottom_block_right.appendChild(dom_download_android)
  bottom_block_right.appendChild(android_text)

  bottom_bar.appendChild(bottom_block_left)
  bottom_bar.appendChild(bottom_block_right)
...
function onDownloadLangFileForPC(data){
  BTS.I18N = data.website;
  BTS.TEXTS = BTS.I18N.slide;
  showContainer();
}

function onDownloadLangFileForMobile(data){
  BTS.I18N = data.website;
  BTS.TEXTS = BTS.I18N.slide;
  createMobileLayout();
}
